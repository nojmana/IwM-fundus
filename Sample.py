...
class Sample:
    ...
    @staticmethod
    def generate_csv(sample_size, number_of_pics, number_of_files, sample_path):
        ...
        for file_name in file_list[:number_of_files]:
            data_frame = Sample.create_samples(file_name, sample_size=sample_size,
                                               number_of_pics=number_of_pics, equals_set_sizes=True)
    ...
    def create_samples(file_name, sample_size, number_of_pics, equals_set_sizes):
        ...
        if equals_set_sizes:
            print("Creating samples is in progress! This method will create approximately",
                  int(1.8 * number_of_pics), "pictures")
        else:
